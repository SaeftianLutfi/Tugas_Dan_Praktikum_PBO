...
class FrmMahasiswa1:
    ...
    def onOpen(self):
        ...
        if(self.txtNama.get() == 'Saeftian Lutfi'):
            FrmKuliah1(new_window, 'Data Mata Kuliah Mahasiswa', self.update_main_window)
        elif(self.txtNama.get() == 'Vicky Akbar Fahrezi'):
            FrmKuliah2(new_window,'Data Mata Kuliah Mahasiswa', self.update_main_window)
        elif(self.txtNama.get() == 'Roy Zikin'):
            FrmKuliah3(new_window, 'Data Mata Kuliah Mahasiswa', self.update_main_window)
...
if __name__ == '__main__':
    def update_main_window(result):
        ...
        root = tk.Tk()
        aplikasi = FrmMahasiswa1(root, "Data Mahasiswa", update_main_window)
        root.mainloop()