...
class Dashboard:
    def __init__(self):
        ...
        self.file_menu.add_command(label='Login', command=lambda: self.new_window("Login", FromLogin))
        self.file_menu.add_command(label='Logout', command=self.root.destroy)
        
        # add menu items to menu Admin
        self.admin_menu.add_command(label='Admin-1', command=lambda: self.new_window("Luas Persegi Panjang", Frmpersegipanjang))
        ...
        self.mahasiswa_menu.add_command(label='Mahasiswa-1', command=lambda: self.new_window("Luas Persegi Panjang", Frmpersegipanjang))
        ...
        self.dosen_menu.add_command(label='Dosen-1', command=lambda: self.new_window("Luas Persegi Panjang", Frmpersegipanjang))
