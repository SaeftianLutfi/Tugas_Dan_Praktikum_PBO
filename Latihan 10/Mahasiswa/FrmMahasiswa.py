...
from Mahasiswa import dbMahasiswa
...
class FormMahasiswa:
    ...
    def aturKomponen(self):
        ...
        self.L = Radiobutton(mainFrame, text='Laki-laki', value='Laki-laki', variable=self.txtJK)
        self.L.grid(row=2, column=1, padx=5, pady=5, sticky=W)
        self.L.select() # set pilihan yg pertama
        self.P = Radiobutton(mainFrame, text='Perempuan', value='Perempuan', variable=self.txtJK)
